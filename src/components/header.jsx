    ...
    <div className='head' style={{backgroundColor:hbackdarkmode||'#222831',color:hdarkmode||'white', height:'10vh',minHeight:60,width:'120vw', marginLeft:'-8.4vw', marginTop:-35, display:'flex', alignItems:'center', overflowX:'hidden'}}>
      ...
      <motion.div id='profile' >
          <motion.div style={{display:'flex', gap:20, marginRight:20, alignItems:'center'}}  >
            ...
            <Link style={linkstyle}   as={Link} to="/about"><motion.h3 style={linkstyle}  whileHover={hovereffect}>About</motion.h3></Link>
            <Link style={linkstyle}   as={Link} to="/"><motion.h3 style={linkstyle}  whileHover={hovereffect}>For Sell</motion.h3></Link>
            <Link style={linkstyle}   as={Link} to="/"><motion.h3 style={linkstyle}  whileHover={hovereffect}>For Rent</motion.h3></Link>
            <Link style={linkstyle}   as={Link} to="/"><motion.h3 style={linkstyle}  whileHover={hovereffect}>Find An Agent</motion.h3></Link>
            |
      ...
      <motion.div  >
        ...
        <motion.div  whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
          ...
          <motion.div  style={{margin:20}}  whileTap={{ scale: 0.95 }}>
          <Link onClick={Hide} style={hiddlenlink} as={Link} to="/about">About</Link>
          </motion.div>
          <motion.div  style={{margin:20}} whileTap={{ scale: 0.95 }}>
          <motion.div style={{margin:20}}   whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
          <Link onClick={Hide} style={hiddlenlink} as={Link} to="/about">Buy</Link>
          </motion.div>
          <Link onClick={Hide} style={hiddlenlink}as={Link} to="/">Sell</Link>
          </motion.div>
          <motion.div style={{margin:20}}   whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
          <Link onClick={Hide} style={hiddlenlink} as={Link} to="/about">Rent</Link>
          </motion.div>
          <motion.div style={{margin:20}}   whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
          <Link onClick={Hide} style={hiddlenlink} as={Link} to="/about">Find An Agent</Link>
          </motion.div>
